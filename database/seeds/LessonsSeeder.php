    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 100; $i++) {
            ...
            DB::table('lessons')->insert([
                ['date_event' =>  date("Y-m-d", $time), 'group_id' => '1', 'subject_id' => '2', 'user_id' => '3', 'class_room_id' => '1', 'lesson' => random_int(1, 6)],
                ['date_event' =>  date("Y-m-d", $time), 'group_id' => '2', 'subject_id' => '3', 'user_id' => '4', 'class_room_id' => '2', 'lesson' => random_int(1, 6)],
                ['date_event' =>  date("Y-m-d", $time), 'group_id' => '3', 'subject_id' => '5', 'user_id' => '6', 'class_room_id' => '3', 'lesson' => random_int(1, 6)],
