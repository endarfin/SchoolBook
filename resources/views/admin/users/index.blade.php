                            ...
                            <tr>
                                <th colspan="10">
                                    <a class="btn btn-outline-info btn-sm"
                                       href="{{ route('admin.users.index') }}">All</a>
                                    <a class="btn btn-outline-info btn-sm"
                                       href="{{ route('admin.users.index') }}?type=3">Administrator</a>
                                    <a class="btn btn-outline-info btn-sm"
                                       href="{{ route('admin.users.index') }}?type=2">Teacher</a>
                                    <a class="btn btn-outline-info btn-sm"
                                       href="{{ route('admin.users.index') }}?type=1">Student</a>
                                    <div class="float-right"><a class="btn btn-outline-primary btn-sm"
